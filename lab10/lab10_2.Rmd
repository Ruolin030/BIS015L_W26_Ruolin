...
```{r}
p+geom_point(size=2) #over plotting(can't tell the difference)
```
...
df <- data.frame(x = 1:25, y = rep(1, 25), shape = 0:24) #0-14 outline shape(will NOT recognize outline shape), 15-20:filled shape
