...
_No, the number of to toepad lamellae is inconsistent across islands. So, even though the trunk-crown lizards have the highest average overall there seems to be variation among islands._
```{r}
anolis %>% 
  filter(habitat=="Trunk-crown") %>%
