...
```{r}
amniota_no_na %>% 
  replace_with_na_all(condition=~.x %in% c(common_na_numbers, common_na_numbers))
```
...
amniota_no_na %>% 
  ...
  miss_var_summary()
```
Yes, this results make sense biologically; because mammals do not lay eggs, they don't have values in the egg mass. NA's in mammals literally represent 0.
