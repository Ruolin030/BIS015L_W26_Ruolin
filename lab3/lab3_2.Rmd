...
We only use tibble() when working in the tidyverse. The equivalent command in base R "data.names()"
...
```{r}
fish <- read_csv("data/Gaeta_etal_CLC_data.csv") #data/ : tell R where it is
```
