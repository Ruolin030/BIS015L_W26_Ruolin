...
We only use tibble() when working in the tidyverse. The equivalent command in base R "data.frames()"
...
```{r}
fish <- read_csv("data/Gaeta_etal_CLC_data.csv") #data/ : tell R where it is. now, fish is in the folder "data"
```
